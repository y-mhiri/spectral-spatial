...
class GradAlignement(ChambollePock):
    ...
    def __init__(self, max_iter=100, lmbda=1, theta=1, sigma=1, tau=1):
        super(GradAlignement, self).__init__(max_iter=max_iter, lmbda=lmbda, theta=theta, sigma=sigma, tau=tau)
