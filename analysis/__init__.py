...
from .plots import plot_single_image, plot_rgb_comparison, plot_convergence_curve, plot_error_map, plot_spectral_signature
...
__all__ = [
    ...
    # Plotting functions  
    'plot_single_image', 'plot_rgb_comparison', 'plot_convergence_curve', 'plot_error_map', 'plot_spectral_signature',
    # Data I/O functions
