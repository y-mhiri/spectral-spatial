...
def main():
    ...
    print_experiment_info(args, 'PANTVCB')
    ...
    # Save results
    store_results(root, args, reconstructed_ar, loss_ar, metrics, total_time, 'PANTVCB')
    save_experiment_info(args.storage_path, args, total_time, metrics, 'PANTVCB')
