...
if __name__ == "__main__":
    ...
    print(f"Running experiment : lambda = {lmbda}, lambda_m = {lmbda_m},p = {p},q = {q} ,r = {r}, noise_level = {noise_level},sigma = {sigma},scale = {scale}")
    print('-----------------------------------')  
    ...
    for j,data in enumerate(subset):
        ...
        reconstructed, loss = optim(Y_H.to(device=cuda,dtype=dtype),Y_M.to(device=cuda,dtype=dtype))
